...
export const StopLoss: FunctionComponent<{
          ...
          {isSettingOpen && (
            ...
            >
              ...
              <div className="flex items-center mt-4">
                <CheckBox
                  isOn={orderTokenInConfig.largerRateEnabled}
                  onToggle={() => orderTokenInConfig.toggleLargerRateEnabled()}
                ...
                >
                  <span className="caption md:text-xs text-sm ml-1">
                    Enable larger rate than market price.
                  </span>
                </CheckBox>
              </div>
            </div>
